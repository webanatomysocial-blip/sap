...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $file = $_FILES['image'];
    // Production Path for Subdomain Structure (api/ and assets/ are siblings)
    $uploadDir = __DIR__ . '/../assets/blog-images/'; 
    ...
    if (move_uploaded_file($file['tmp_name'], $filePath)) {
        echo json_encode([
            ...
            'filename' => $filename,
            // Subdomain root is parent, so assets is at root level relative to domain
